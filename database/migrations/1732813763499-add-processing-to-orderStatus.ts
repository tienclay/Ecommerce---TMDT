...
export class AddProcessingToOrderStatus1732813763499
  implements MigrationInterface
{
  name = 'AddProcessingToOrderStatus1732813763499';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('Pending', 'Completed', 'Cancelled', 'Processing')`,
    );
    await queryRunner.query(
