...
export class FixRelationsCourseUser1732291536087 implements MigrationInterface {
  name = 'FixRelationsCourseUser1732291536087';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "course_tutors" ADD CONSTRAINT "PK_3ec16eecf93e9993a3d0e0dae1d" PRIMARY KEY ("tutor_id", "course_id", "id")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "course_tutors" ADD CONSTRAINT "FK_cd86396f17312ef49862767d65d" FOREIGN KEY ("course_id") REFERENCES "courses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "course_tutors" ADD CONSTRAINT "FK_2a00f6c97b008de708ff45a9271" FOREIGN KEY ("tutor_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
